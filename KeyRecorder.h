...
bool handle_keyboard(WPARAM& wParam, LPARAM& lParam, KBDLLHOOKSTRUCT& ckey, bool* s1, string* guitext, bool* keystate, Queue* recorder) {
	bool result = 0;
	if (wParam == 256) {
...
LRESULT CALLBACK butproc(int nCode, WPARAM wParam, LPARAM lParam) {
